            ...
            <div class="field is-grouped">
              <div id="chooseFileDiv">
                <p class="control">
                  ...
                  v-validate="'required|mimes:image/jpeg, image/png'" :class="{'input': true, 'is-danger': errors.has('image') }" @change="onFileChange" class="input" ref="image" name="image" id="image">
